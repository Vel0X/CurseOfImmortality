...
public:
	...
	UNiagaraComponent* InitializeParticleActor(FVector SpawnLocation, UNiagaraSystem* ParticleSystem, AActor* _FollowParent = nullptr, float ManualDestructionTime = -1.0f);
